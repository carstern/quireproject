...
function getNotes() {
  ...
  // OBS!! tog bort denna för att inte sök fältet ska försvinna
  ...
  const noteDisplayCards = document.querySelectorAll(
    "#nav-output-container > div"
  );
