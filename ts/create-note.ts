...
function createNoteCard(note: Note): HTMLDivElement {
  ...
  card.addEventListener("click", function () {
    const existingViewNoteCard = document.getElementById(
      "view-note-card"
    ) as HTMLDivElement | null;
    ...
    if (clickedNote) {
      ...
      const saveBtn = mainOutputContainer.querySelector(
        "#save-note-button"
      ) as HTMLButtonElement | null;
      ...
      if (saveBtn) {
        saveBtn.addEventListener("click", function () {
          const updatedTitleInput = document.getElementById(
            "notesTitle"
          ) as HTMLInputElement | null;
          const updatednoteDiv = document.getElementById(
            "noteInput"
          ) as HTMLDivElement | null;
