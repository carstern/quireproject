...
function createNewNote() {
  ...
  if (saveBtn) {
    saveBtn.addEventListener("click", function () {
      ...
      const noteTextArea: HTMLDivElement | null = document.getElementById(
        "noteInput"
      ...
      if (titleInput && noteTextArea) {
        ...
        const savedNote: string = noteTextArea.innerText;
...
function getNotesFromLocalStorage() {
  const navOutputContainer: HTMLDivElement | null = document.getElementById(
    "nav-output-container"
  ) as HTMLDivElement | null;
  const mainOutputContainer: HTMLDivElement | null = document.getElementById(
    "main-output-container"
  ) as HTMLDivElement | null;
  ...
  if (navOutputContainer && mainOutputContainer) {
    ...
    savedNotes.forEach((note, index) => {
      ...
      card.addEventListener("click", function () {
        ...
        const existingViewNoteCard: HTMLDivElement | null =
          document.getElementById("view-note-card") as HTMLDivElement | null;
        ...
        const saveBtn: HTMLButtonElement | null =
          mainOutputContainer.querySelector(
            "#save-note-button"
          ) as HTMLButtonElement | null;
        ...
        if (saveBtn) {
          saveBtn.addEventListener("click", function () {
            ...
            const updatedTitleInput: HTMLInputElement | null =
              document.getElementById("notesTitle") as HTMLInputElement | null;
            const updatedNoteTextArea: HTMLDivElement | null =
              document.getElementById("noteInput") as HTMLDivElement | null;
            ...
            if (updatedTitleInput && updatedNoteTextArea) {
              ...
              const updatedNote: string = updatedNoteTextArea.innerText;
              ...
              console.error(
                "Error: updatedTitleInput or updatedNoteTextArea is null"
              );
            }
          });
        } else {
